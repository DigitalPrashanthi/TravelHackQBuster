        ...
        ViewTreeObserver.OnGlobalLayoutListener
{
    ...
    private Vector<String> vecConnectedDeviceNames;
    private int width;
    private int height;
    ...
    public void addConnectedDevicesNames(String value) {
        if (vecConnectedDeviceNames.size() < MAX)
        {
            if (!vecConnectedDeviceNames.contains(value))
                vecConnectedDeviceNames.add(value);
        }
    }
    public void removeConnectedDevicesName(String value) {
        if (!vecConnectedDeviceNames.contains(value))
            vecConnectedDeviceNames.remove(value);
    }
    ...
    private void init(AttributeSet attrs, Context context)
    {
        ...
        vecConnectedDeviceNames = new Vector<String>(MAX);
    ...
    public void show()
    {
        ...
        if (width > 0 && height > 0 && vecKeywords != null && vecKeywords.size() > 0)
        {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                int shadowColor = 0xdd696969;
                txt.setShadowLayer(1, 1, 1, shadowColor);
                txt.setGravity(Gravity.CENTER);
                if(vecConnectedDeviceNames!=null && !vecConnectedDeviceNames.contains(keyword))
