...
public class RippleView extends android.support.v7.widget.AppCompatTextView {
    ...
    // private static final int DEFAULT_RIPPLE_COLOR = Color.rgb(0, 0, 0);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (modeWidth == View.MeasureSpec.EXACTLY) {
            ...
            if (modeWidth == View.MeasureSpec.AT_MOST) {
        ...
        if (modeHeight == View.MeasureSpec.EXACTLY) {
            resultHeight = sizeHeight;
        } else {
            resultHeight = mMinSize;
            if (modeHeight == View.MeasureSpec.AT_MOST) {
